...
//idea from https://www.youtube.com/watch?v=HedMwVT6J3M
//and from https://blog.naver.com/renucs/221393078919
...
extern unsigned long last_move_millis;
...
void setup() {
 ...
 pinMode(led, OUTPUT); //Right Backward
...
void loop() {
  ...
  if(currentMillis - last_move_millis > 500)
  {
    digitalWrite(gpLb, HIGH);
    digitalWrite(gpLf, HIGH);
    digitalWrite(gpRb, HIGH);
